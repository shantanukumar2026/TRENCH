    ...
    <div className="py-16 bg-[#F8FAFC]">
      <div className="container-custom space-y-12">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white p-8 rounded-2xl border-2 border-blue-200 shadow-xl">
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="flex flex-wrap gap-4 pt-2 font-mono text-xs">
                <div className="px-3 py-1.5 rounded bg-[#F0F7FF] border border-blue-200 text-[#0754AE] font-bold">
            ...
            <div className="lg:col-span-5 relative h-64 rounded-xl overflow-hidden border-2 border-blue-300 shadow-lg">
              <img
                src={category.image}
                alt={category.title}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {category.subcategories.map((subcat) => (
              <div
                ...
                className="bg-white rounded-xl border border-blue-200 p-6 hover:border-[#2166D1] hover:shadow-xl transition-all duration-300 group cursor-pointer flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="h-36 rounded-lg overflow-hidden border border-blue-100 bg-[#F0F7FF] relative">
                    <img
                    ...
                    />
                    <div className="absolute top-2 right-2 px-2 py-0.5 rounded bg-[#0754AE] text-white text-[10px] font-mono font-bold">
                      SUBCATEGORY
                    </div>
                  </div>
          ...
          <div className="space-y-6 pt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {categoryProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-white rounded-xl border border-blue-200 overflow-hidden hover:border-[#2166D1] hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
                >
                  <div className="p-5 space-y-4">
                    <div className="h-44 rounded-lg overflow-hidden border border-blue-100 bg-[#F0F7FF] relative group cursor-pointer" onClick={() => onSelectProduct(product)}>
                      <img
                        src={product.image}
                        alt={product.name}
                        onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/images/trench_shield.png'; }}
                    ...
                    <div className="space-y-1.5 font-mono text-xs bg-[#F0F7FF] p-3 rounded border border-blue-100">
                  ...
                  <div className="p-4 bg-[#F0F7FF] border-t border-blue-100 flex gap-2">
                    <button
                      onClick={() => onSelectProduct(product)}
                      className="flex-1 py-2.5 bg-white border border-blue-200 hover:border-[#2166D1] text-[#0754AE] text-xs font-mono font-bold rounded flex items-center justify-center gap-1.5 transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 py-2.5 bg-[#0754AE] hover:bg-[#2166D1] text-white text-xs font-mono font-bold rounded flex items-center justify-center gap-1.5 transition-colors"
                    >
